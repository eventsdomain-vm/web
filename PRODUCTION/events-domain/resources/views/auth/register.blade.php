<x-guest-layout>
    <x-slot name="title">Create Account | EventsDomain - B2B Event Sponsorship Marketplace</x-slot>
    <x-slot name="meta_description">Create your EventsDomain account - Join India's B2B Event Sponsorship & Partnership Marketplace as an Organizer, Sponsor, or Partner.</x-slot>
