<x-guest-layout>
    <x-slot name="title">Sign In | EventsDomain - B2B Event Sponsorship Marketplace</x-slot>
    <x-slot name="meta_description">Sign in to EventsDomain - India's B2B Event Sponsorship & Partnership Marketplace. Access your organizer, sponsor, or partner dashboard.</x-slot>
