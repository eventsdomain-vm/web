<x-guest-layout>
    <x-slot name="title">Event Sponsorship ROI Calculator | EventsDomain</x-slot>
    <x-slot name="meta_description">Calculate your event sponsorship ROI with our free tool — factor in celebrity presence, media coverage, and digital amplification. Free tool for sponsors.</x-slot>
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 max-h-[75vh] overflow-y-auto space-y-6" id="inputs-container">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    @foreach([
                                        ...
                                        <div class="space-y-1.5">
                                            <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wider">{{ $category }}</h4>
                                            <div class="space-y-1">
                                                @foreach($items as $val => $lbl)
                                                    <label class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50 cursor-pointer transition select-none">
                                                        <input type="checkbox" name="benefits" value="{{ $val }}" onchange="calculate()"
                        ...
                        {{-- Section 4: Digital Amplification --}}
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                {{-- Streaming Platforms count (hidden by default) --}}
                        ...
                        {{-- Section 6: Organizer Credibility --}}
                        <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden lg:sticky lg:top-24">
                    ...
                    <div class="p-6 max-h-[75vh] overflow-y-auto space-y-6" id="results-container">
                        ...
                        {{-- Placeholder view (when not complete) --}}
