...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Submit Event - EventsDomain <?php $__env->endSlot(); ?>
    ...
    <div x-data="eventCreateWizard(<?php echo \Illuminate\Support\Js::from($draft->data ?? [])->toHtml() ?>, <?php echo e($draft->current_step ?? 1); ?>)"
         x-init="init()"
         data-plans='<?php echo json_encode($plans, 15, 512) ?>'
         data-audience-types='<?php echo json_encode($audienceTypes, 15, 512) ?>'
         data-age-groups='<?php echo json_encode($ageGroups, 15, 512) ?>'
         data-industries='<?php echo json_encode($industries, 15, 512) ?>'
         data-categories='<?php echo json_encode($categories, 15, 512) ?>'
         class="max-w-5xl mx-auto space-y-6 pb-12">

        
        <div class="text-sm text-gray-500 flex items-center gap-2">
            <a href="<?php echo e(route('organizer.dashboard')); ?>" class="hover:text-gray-700 transition">Dashboard</a>
            <span>&rsaquo;</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select x-model="data.start_time" 
                                ...
                                <?php $__currentLoopData = range(0, 47); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $h = floor($slot / 2); $m = ($slot % 2) * 30; $timeStr = sprintf('%02d:%02d', $h, $m); ?>
                                    <option value="<?php echo e($timeStr); ?>"><?php echo e($timeStr); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
            ...
            return {
                ...
                async saveDraft() {
                    ...
                    try {
                        ...
                        const response = await fetch('<?php echo e(route("organizer.events.submit-draft")); ?>', {
                            method: 'POST',
                            headers: {
                ...
                async clearDraft() {
                    ...
                    try {
                        await fetch('<?php echo e(route("organizer.events.clear-submit-draft")); ?>', {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                                'Accept': 'application/json'
                ...
                async uploadCoverImage(file) {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route("organizer.events.upload-image")); ?>', {
                            method: 'POST',
                ...
                async submitForm() {
                    ...
                    try {
                        ...
                        const response = await fetch('<?php echo e(route("organizer.events.submit-final")); ?>', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\vm\events-domain\resources\views/organizer/events/create.blade.php ENDPATH**/ ?>