...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Partner With Us - EventsDomain <?php $__env->endSlot(); ?>

    
    <section class="bg-terracotta-500 text-white">
        ...
        <div class="container-page">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8">
                        <form method="POST" action="<?php echo e(route('partners.store')); ?>" class="space-y-5">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="company_name" id="company_name" required value="<?php echo e(old('company_name')); ?>"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-terracotta-500 focus:ring-terracotta-500 text-sm"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="partnership_type" id="partnership_type" required
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-terracotta-500 focus:ring-terracotta-500 text-sm">
                                    <option value="" disabled <?php echo e(old('partnership_type') ? '' : 'selected'); ?>>Select partnership type</option>
                                    <option value="event_agency" <?php echo e(old('partnership_type') == 'event_agency' ? 'selected' : ''); ?>>Event Agency</option>
                                    <option value="venue" <?php echo e(old('partnership_type') == 'venue' ? 'selected' : ''); ?>>Venue / Destination</option>
                                    <option value="media" <?php echo e(old('partnership_type') == 'media' ? 'selected' : ''); ?>>Media Partner</option>
                                    <option value="technology" <?php echo e(old('partnership_type') == 'technology' ? 'selected' : ''); ?>>Event Technology</option>
                                    <option value="other" <?php echo e(old('partnership_type') == 'other' ? 'selected' : ''); ?>>Other</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" required rows="4"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-terracotta-500 focus:ring-terracotta-500 text-sm"
                                    placeholder="Tell us about your organization and how you'd like to partner with us..."><?php echo e(old('message')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\vm\events-domain\resources\views/partners/index.blade.php ENDPATH**/ ?>