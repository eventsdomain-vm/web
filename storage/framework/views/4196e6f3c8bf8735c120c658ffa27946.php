        ...
        <div class="container-page">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $featuredEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('events.show', $event->slug ?? $event->id)); ?>" class="card-hover group">
                        <div class="relative h-48 overflow-hidden">
                            <?php if($event->cover_image_url): ?>
                                <img src="<?php echo e($event->cover_image_url); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" onerror="this.parentElement.innerHTML='<div class=&quot;w-full h-full bg-gradient-to-br from-terracotta-400 to-terracotta-700&quot;></div>'">
                            <?php else: ?>
                                <div class="w-full h-full bg-gradient-to-br from-terracotta-400 to-terracotta-700"></div>
                            <?php endif; ?>
                            <?php if($event->is_featured): ?>
                                <div class="absolute top-3 left-3">
                                    <span class="badge-dark text-xs">Featured</span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="p-5">
                            <div class="flex items-center gap-2 mb-3">
                                <span class="badge-primary text-xs"><?php echo e($event->category->name ?? 'General'); ?></span>
                                <span class="badge-success text-xs">Open</span>
                            </div>
                            <h3 class="font-bold text-lg text-gray-900 mb-2 group-hover:text-terracotta-600 transition line-clamp-1"><?php echo e($event->title); ?></h3>
                            <p class="text-gray-500 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($event->description, 120)); ?></p>
                            ...
                            <div class="flex items-center text-sm text-gray-400 mb-4">
                                ...
                                <?php echo e($event->city ?? 'India'); ?>

                            </div>
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                <span class="text-terracotta-600 font-bold text-sm"><?php echo e(number_format($event->expected_audience ?? 0)); ?>+ Attendees</span>
                                <span class="text-terracotta-500 font-semibold text-sm group-hover:translate-x-1 transition-transform inline-flex items-center">View Details <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg></span>
                            </div>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <?php $__currentLoopData = [1, 2, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card-hover">
                            <div class="h-48 bg-gradient-to-br from-terracotta-100 to-terracotta-200"></div>
                            <div class="p-5">
                                <div class="flex items-center gap-2 mb-3">
                                    <span class="badge-primary text-xs">Technology</span>
                                    <span class="badge-success text-xs">Open</span>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\vm\events-domain\resources\views/welcome.blade.php ENDPATH**/ ?>