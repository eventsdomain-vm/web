...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.user-avatar','data' => ['size' => 'w-9 h-9','fontSize' => 'text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'w-9 h-9','fontSize' => 'text-xs']); ?>
    ...
    >
        ...
        <div class="py-1">
            ...
            <?php if(auth()->user()->hasRole('organizer')): ?>
                <a
                    href="<?php echo e(route('organizer.social.index')); ?>"
                    class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition"
                    role="menuitem"
                >
                    <svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <?php elseif(auth()->user()->hasRole('partner')): ?>
                <a
                    href="<?php echo e(route('partner.social.index')); ?>"
                    class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition"
                    role="menuitem"
                >
                    <svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
...
<?php /**PATH C:\xampp\htdocs\vm\events-domain\resources\views/components/ui/profile-dropdown.blade.php ENDPATH**/ ?>