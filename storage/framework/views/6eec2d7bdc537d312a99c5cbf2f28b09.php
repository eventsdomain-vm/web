...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3" x-data="{ showShareModal: false }">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('organizer.events.edit', $event)); ?>" class="btn-outline text-sm">Edit Event</a>
                <a href="<?php echo e(route('organizer.events.index')); ?>" class="text-sm text-gray-500 hover:text-gray-700 transition">← Back</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-terracotta-800 to-terracotta-950 min-h-[280px] flex items-end">
                ...
                <div class="relative z-10 p-6 md:p-8 w-full">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="badge-<?php echo e($event->status_color); ?>"><?php echo e($event->status_label); ?></span>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e($event->website_url); ?>" target="_blank" class="font-semibold text-terracotta-500 hover:underline"><?php echo e($event->website_url); ?></a>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between py-2 border-b border-gray-50">
                        ...
                        <span class="font-bold text-gray-900"><?php echo e(number_format($event->views_count)); ?></span>
                    </div>
                    <div class="flex items-center justify-between py-2 border-b border-gray-50">
                        <span class="text-sm text-gray-500">Sponsorship Requests</span>
                        <span class="font-bold text-gray-900"><?php echo e($event->sponsorshipRequests->count()); ?></span>
                    </div>
                    <div class="flex items-center justify-between py-2">
                        <span class="text-sm text-gray-500">Gallery Images</span>
                        <span class="font-bold text-gray-900"><?php echo e($event->gallery->count()); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $event->sponsorshipRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="border-b border-gray-100 last:border-0 py-3">
                        <div class="flex items-center justify-between mb-1">
                            <span class="font-medium text-gray-900"><?php echo e($request->sponsor->name); ?></span>
                            <span class="badge-<?php echo e($request->status_color); ?> text-xs"><?php echo e($request->status_label); ?></span>
                        </div>
                        <p class="text-sm text-gray-500"><?php echo e($request->package->title ?? 'N/A'); ?></p>
                        <?php if($request->budget_offer): ?>
                            <p class="text-sm text-terracotta-500 font-medium mt-1">Offered: ₹<?php echo e(number_format($request->budget_offer)); ?></p>
                        <?php endif; ?>
                        <?php if($request->message): ?>
                            <p class="text-xs text-gray-400 mt-1 line-clamp-2"><?php echo e($request->message); ?></p>
                        <?php endif; ?>
                        <?php if($request->status === 'pending'): ?>
                            <div class="flex items-center gap-2 mt-2">
                                <form action="<?php echo e(route('organizer.requests.accept', [$event, $request])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('organizer.requests.reject', [$event, $request])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="card p-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $event->partnerBids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="border-b border-gray-100 last:border-0 py-3">
                        <div class="flex items-center justify-between mb-1">
                            <span class="font-medium text-gray-900"><?php echo e($bid->partner->name); ?></span>
                            <span class="badge-<?php echo e($bid->status_color); ?> text-xs"><?php echo e($bid->status_label); ?></span>
                        </div>
                        <p class="text-sm text-gray-500"><?php echo e($bid->service->title ?? 'N/A'); ?></p>
                        <?php if($bid->quote_amount): ?>
                            <p class="text-sm text-terracotta-500 font-medium mt-1">Quote: ₹<?php echo e(number_format($bid->quote_amount)); ?></p>
                        <?php endif; ?>
                        <?php if($bid->quote_note): ?>
                            <p class="text-xs text-gray-400 mt-1 line-clamp-2"><?php echo e($bid->quote_note); ?></p>
                        <?php endif; ?>
                        <?php if($bid->status === 'pending'): ?>
                            <div class="flex items-center gap-2 mt-2">
                                <form action="<?php echo e(route('organizer.bids.accept', [$event, $bid])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="px-3 py-1 text-xs font-medium text-white bg-emerald-500 rounded-lg hover:bg-emerald-600 transition">Accept</button>
                                </form>
                                <form action="<?php echo e(route('organizer.bids.reject', [$event, $bid])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="px-3 py-1 text-xs font-medium text-white bg-red-500 rounded-lg hover:bg-red-600 transition">Reject</button>
                                </form>
                            </div>
            ...
            <div class="card p-6">
                <h3 class="font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <svg class="w-5 h-5 text-terracotta-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                    Sponsor Proposals (<?php echo e($event->sponsorProposals->count()); ?>)
                </h3>
                <?php $__empty_1 = true; $__currentLoopData = $event->sponsorProposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="border-b border-gray-100 last:border-0 py-4">
                        <div class="flex items-center justify-between mb-2">
                            <div>
                                <span class="font-medium text-gray-900"><?php echo e($proposal->sponsor->name); ?></span>
                                <p class="text-sm text-gray-500"><?php echo e($proposal->package->title ?? 'N/A'); ?> • ₹<?php echo e(number_format($proposal->budget_offer ?? $proposal->package->price ?? 0)); ?></p>
                            </div>
                        ...
                        <?php if($proposal->message): ?>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($proposal->message, 100)); ?></p>
                        <?php endif; ?>
                        <div class="flex items-center gap-2 mt-3 flex-wrap">
                            <?php if($proposal->status === 'submitted'): ?>
                                <form action="<?php echo e(route('organizer.proposals.shortlist', [$event, $proposal])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="text-xs px-3 py-1 rounded-full bg-blue-50 text-blue-600 hover:bg-blue-100">Shortlist</button>
                                </form>
                                <form action="<?php echo e(route('organizer.proposals.negotiate', [$event, $proposal])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('organizer.proposals.accept', [$event, $proposal])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                ...
                                <button type="button" class="text-xs px-3 py-1 rounded-full bg-red-50 text-red-600 hover:bg-red-100" onclick="confirmReject('<?php echo e($proposal->id); ?>', '<?php echo e($event->id); ?>')">Reject</button>
                            <?php elseif($proposal->status === 'viewed' || $proposal->status === 'shortlisted'): ?>
                                <form action="<?php echo e(route('organizer.proposals.negotiate', [$event, $proposal])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="organizer_note" value="">
                            ...
                            <?php elseif($proposal->status === 'negotiating'): ?>
                                <button type="button" class="text-xs px-3 py-1 rounded-full bg-purple-50 text-purple-600 hover:bg-purple-100" onclick="openCounterModal('<?php echo e($proposal->id); ?>', '<?php echo e($event->id); ?>')">Send Counter</button>
                                <form action="<?php echo e(route('organizer.proposals.accept', [$event, $proposal])); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="text-xs px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 hover:bg-emerald-100">Accept</button>
                                </form>
                            <?php elseif($proposal->status === 'counter_offer'): ?>
                                <p class="text-xs text-gray-500">Waiting for sponsor response to counter offer</p>
                            <?php elseif($proposal->status === 'agreed'): ?>
            ...
            <div class="card p-6">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('organizer.events.schedules.index', $event)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($event->schedule->count()); ?> items</p>
                        </div>
                    ...
                    <a href="<?php echo e(route('organizer.events.packages.index', $event)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                        <div class="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        </div>
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 group-hover:text-terracotta-600 transition">Packages</p>
                            <p class="text-xs text-gray-500"><?php echo e($event->packages->count()); ?> packages</p>
                        </div>
                        <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                    </a>
                    <a href="<?php echo e(route('organizer.events.gallery.index', $event)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($event->gallery->count()); ?> images</p>
                        </div>
                        <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                    </a>
                    <a href="<?php echo e(route('organizer.events.team.index', $event)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($event->team->count()); ?> members</p>
                        </div>
                        <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                    </a>
                </div>
            ...
            <div class="card p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('events.show', $event->slug)); ?>" target="_blank" class="btn-outline w-full block text-center text-sm flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                        View Public Page
                    </a>
                    <form action="<?php echo e(route('organizer.events.destroy', $event)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this event? This action cannot be undone.')">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        function confirmReject(proposalId, eventId) {
            ...
            form.action = `<?php echo e(route('organizer.proposals.reject', ['event' => ':event', 'proposal' => ':proposal'])); ?>`
        ...
        function openCounterModal(proposalId, eventId) {
            ...
            form.action = `<?php echo e(route('organizer.proposals.counter', ['event' => ':event', 'proposal' => ':proposal'])); ?>`
                .replace(':event', eventId)
                .replace(':proposal', proposalId);
            modal.classList.remove('hidden');
        }
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\vm\resources\views/organizer/events/show.blade.php ENDPATH**/ ?>