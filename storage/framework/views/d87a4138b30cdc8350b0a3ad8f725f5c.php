...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <span class="px-3 py-1 bg-terracotta-50 text-terracotta-700 text-sm font-medium rounded-full capitalize"><?php echo e($profile['profile']['org_type'] ?? 'Not Set'); ?> Sponsor</span>
        </div>
     <?php $__env->endSlot(); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <section class="card overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between gap-3">
                        ...
                        <span class="px-2.5 py-1 bg-green-100 text-green-700 text-xs font-medium rounded-full whitespace-nowrap"><?php echo e($profile['completion_percentage']); ?>% Complete</span>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Legal Name</label>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($profile['profile']['name']); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Industry</label>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($profile['profile']['industry'] ?? 'Not set'); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Organization Type</label>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($profile['profile']['org_type'] ?? 'Not set'); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Business Email</label>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($profile['profile']['business_email']); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Website</label>
                                <p class="mt-1 text-sm font-medium text-gray-900">
                                    <a href="<?php echo e($profile['profile']['website']); ?>" target="_blank" class="text-terracotta-500 hover:underline"><?php echo e($profile['profile']['website']); ?></a>
                                </p>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide">Budget (Current FY)</label>
                                <p class="mt-1 text-sm font-medium text-gray-900">₹<?php echo e(number_format($profile['plan_status']['budget']['current_fiscal_year']['total_budget'] ?? 0)); ?></p>
                            </div>
                        </div>

                        <?php if(!empty($profile['next_steps'])): ?>
                            <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
                                <h4 class="text-sm font-semibold text-yellow-800">Next Steps to Complete Your Profile</h4>
                                <ul class="mt-2 text-sm text-yellow-700 space-y-1">
                                    <?php $__currentLoopData = $profile['next_steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex gap-2"><span>•</span><span><?php echo e($step); ?></span></li>
                                    ...
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex flex-wrap items-center gap-3 mt-3">
                                                <span class="px-2 py-1 bg-terracotta-100 text-terracotta-700 text-xs font-medium rounded"><?php echo e(str_replace('_', ' ', $objective->objective_type)); ?></span>
                                        ...
                                        <a href="<?php echo e(route('sponsor.plan.objectives')); ?>" class="text-terracotta-500 hover:underline text-sm font-medium shrink-0">Manage</a>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <section class="card overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between gap-3">
                        ...
                        <a href="<?php echo e(route('sponsor.plan.preferences')); ?>" class="btn-primary text-sm px-3.5 py-2 inline-flex items-center gap-1.5">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                            Set Preferences
                        </a>
                    </div>

                    <?php if($profile['plan_status']['preferences']['exists']): ?>
                        <div class="divide-y divide-gray-100">
                            <div class="p-6">
                                <h4 class="font-medium text-gray-900 mb-3 text-sm">Target Industries</h4>
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $profile['plan_status']['preferences']['industry_targets'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="px-2.5 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full"><?php echo e($industry); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!count($profile['plan_status']['preferences']['industry_targets'] ?? [])): ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php $formats = $profile['plan_status']['preferences']['formats_preferred'] ?? []; ?>
                                    <?php $__currentLoopData = ['physical', 'virtual', 'hybrid', 'digital']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="px-2.5 py-1 <?php echo e(in_array($format, $formats) ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'); ?> text-xs font-medium rounded-full"><?php echo e(ucfirst($format)); ?> <?php echo e(in_array($format, $formats) ? '✓' : ''); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($profile['plan_status']['preferences']['min_audience_size'] ?? 'Not set'); ?></p>
                                    </div>
                                    <div>
                                        <label class="block text-xs text-gray-500">Max Audience</label>
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($profile['plan_status']['preferences']['max_audience_size'] ?? 'Not set'); ?></p>
                                    </div>
                                    <div>
                                        <label class="block text-xs text-gray-500">Budget Range</label>
                                        <p class="text-sm font-medium text-gray-900">
                                            <?php $budgetRange = $profile['plan_status']['preferences']['budget_range'] ?? []; ?>
                                            <?php echo e(isset($budgetRange['min']) ? '₹' . number_format($budgetRange['min']) : 'Not set'); ?>

                                            <?php if(isset($budgetRange['min']) && isset($budgetRange['max'])): ?> – ₹<?php echo e(number_format($budgetRange['max'])); ?><?php endif; ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="card overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between gap-3">
                        ...
                        <a href="<?php echo e(route('sponsor.plan.budgets')); ?>" class="btn-primary text-sm px-3.5 py-2 inline-flex items-center gap-1.5">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                            Manage Budgets
                        </a>
                    </div>

                    <?php if($profile['plan_status']['budget']['current_fiscal_year']): ?>
                        <?php
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap items-start justify-between gap-4 mb-5">
                                <div>
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-semibold text-lg text-gray-900"><?php echo e($fy['fiscal_year']); ?> Fiscal Year</h4>
                                        <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700"><?php echo e(ucfirst($fy['status'])); ?></span>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide">Total Budget</p>
                                    <p class="text-2xl font-bold text-gray-900">₹<?php echo e(number_format($fy['total_budget'] ?? 0, 2)); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-5">
                                <div class="p-3.5 bg-gray-50 rounded-xl">
                                    ...
                                    <p class="text-sm font-semibold text-gray-900">₹<?php echo e(number_format($fy['allocated_so_far'] ?? 0, 2)); ?></p>
                                </div>
                                <div class="p-3.5 bg-gray-50 rounded-xl">
                                    <p class="text-xs text-gray-500">Remaining</p>
                                    <p class="text-sm font-semibold text-gray-900">₹<?php echo e(number_format($rem, 2)); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
            ...
            <div class="space-y-6">
                ...
                <section class="card overflow-hidden" x-data="recommendationsPanel()" x-ref="panel">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <form x-ref="form" action="<?php echo e(route('sponsor.plan.generate-recommendations')); ?>" method="POST" @submit.prevent="generate($refs.form)" class="mt-2">
                            <?php echo csrf_field(); ?>
                ...
                <section class="card overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 gap-2">
                        <a href="<?php echo e(route('sponsor.plan.objectives')); ?>" class="w-full text-left px-4 py-2.5 text-sm rounded-lg hover:bg-gray-50 transition flex items-center gap-2"><span class="text-terracotta-500">•</span> Create Sponsorship Objectives</a>
                        <a href="<?php echo e(route('sponsor.plan.preferences')); ?>" class="w-full text-left px-4 py-2.5 text-sm rounded-lg hover:bg-gray-50 transition flex items-center gap-2"><span class="text-terracotta-500">•</span> Set Target Preferences & AI Matching</a>
                        <a href="<?php echo e(route('sponsor.plan.budgets')); ?>" class="w-full text-left px-4 py-2.5 text-sm rounded-lg hover:bg-gray-50 transition flex items-center gap-2"><span class="text-terracotta-500">•</span> Allocate Budget for Fiscal Year</a>
                        <a href="<?php echo e(route('sponsor.events.index')); ?>" class="w-full text-left px-4 py-2.5 text-sm rounded-lg hover:bg-gray-50 transition flex items-center gap-2"><span class="text-terracotta-500">•</span> Browse Events & Start Proposals</a>
                    </div>
                </section>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\vm\events-domain\resources\views/sponsor/plan/index.blade.php ENDPATH**/ ?>