...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <span class="inline-flex items-center px-3 h-11 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-sm text-gray-600 font-medium select-none">+91</span>
                                    <input id="mobile" name="mobile" type="tel" value="<?php echo e(old('mobile')); ?>"
                                        placeholder="Enter 10-digit number"
                                        maxlength="10"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                        class="h-11 w-full rounded-r-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-terracotta-400 focus:ring-3 focus:ring-terracotta-100 focus:outline-none transition">
                                </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <label class="relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 cursor-pointer transition has-[:checked]:border-terracotta-500 has-[:checked]:bg-terracotta-50 border-gray-200 hover:border-gray-300 bg-white">
                                    <input type="radio" name="role" value="organizer" class="sr-only peer" <?php echo e(old('role', 'organizer') === 'organizer' ? 'checked' : ''); ?>>
                                ...
                                <label class="relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 cursor-pointer transition has-[:checked]:border-terracotta-500 has-[:checked]:bg-terracotta-50 border-gray-200 hover:border-gray-300 bg-white">
                                    <input type="radio" name="role" value="sponsor" class="sr-only peer" <?php echo e(old('role') === 'sponsor' ? 'checked' : ''); ?>>
                                ...
                                <label class="relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 cursor-pointer transition has-[:checked]:border-terracotta-500 has-[:checked]:bg-terracotta-50 border-gray-200 hover:border-gray-300 bg-white">
                                    <input type="radio" name="role" value="partner" class="sr-only peer" <?php echo e(old('role') === 'partner' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="mt-6 text-center text-sm text-gray-500">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="font-semibold text-terracotta-600 hover:text-terracotta-700 transition">Sign In</a>
                </p>
            </div>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\vm\resources\views/auth/register.blade.php ENDPATH**/ ?>