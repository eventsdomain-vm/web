    ...
    <div x-data="{ tab: '{{ $tab }}' }" class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="relative overflow-hidden rounded-xl bg-gradient-to-r from-terracotta-500 to-orange-500 p-4 text-white">
            ...
            <div class="relative z-10 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white/60 text-[11px] mt-0.5">{{ $profile->organization_name ?? $profile->company_name ?? 'Organizer' }}</p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('organizer.profile.update') }}" enctype="multipart/form-data">
            ...
            <div x-show="tab === 'organization'" x-cloak class="card p-6 space-y-6">
                ...
                <div class="flex items-center gap-6 p-4 bg-gray-50 rounded-xl">
                    <div class="relative">
                        <img src="{{ $profile->organization_logo ? Storage::url($profile->organization_logo) : asset('images/default-avatar.png') }}" class="w-20 h-20 rounded-xl object-cover border-2 border-white shadow-sm bg-white" id="logoPreview">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="organization_name" value="{{ old('organization_name', $profile->organization_name) }}" class="input-field" placeholder="Your Company Pvt. Ltd.">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="url" name="social_media_link" value="{{ old('social_media_link', $profile->social_media_link) }}" class="input-field" placeholder="https://linkedin.com/company/your-company">
                    </div>
                    <div>
                        <label class="label">Established Year</label>
                        <input type="number" name="founded_year" value="{{ old('founded_year', $profile->founded_year) }}" class="input-field" min="1900" max="2100" placeholder="2020">
                    </div>
                </div>
